...
*******************************************
"sdfopen GLDAS_NOAH025_24HR.A20230416.AIRTEMP.nc4"
"set lon 73 89"
"set lat 15 32"
"set xlopts 1 5 0.15"
"set ylopts 1 5 0.15"
...
"d max((tair_f_inst-273.16),t=1,t=8)"
"draw shp sd_boundary.shp"
"run grmask.gs"
"draw title GLDAS_Tmax"
"run cbarn"
"printim GLDAS_April16042023-MAXTEMP_GWB_BIH_OD_CAP_PUNJ_HAR.jpg x1000 y741 white"
*"quit"
"close 1"
"c"
...
"set clevs 24 26 28 30 32 34 36 38 40 42 45 47"
"set ccols 0 37 40 45 51 55 59 63 67 71 75 79 83 86"
"d max((tmax_2mabovegro-273.16),t=1,t=8)"
"draw shp sd_boundary.shp"
"run grmask.gs"
"draw title GFS_Tmax"
"run cbarn"
"printim GFS_April16042023-MAXTEMP_GWB_BIH_OD_CAP_PUNJ_HAR.jpg x1000 y741 white"
"close 1"
"c"
...
"set clevs 24 26 28 30 32 34 36 38 40 42 45 47"
"set ccols 0 37 40 45 51 55 59 63 67 71 75 79 83 86"
"d max((tmp_2mabovegrou-273.16), t=1,t=8)"
"draw shp sd_boundary.shp"
"run grmask.gs"
"draw title RTMA_Tmax"
"run cbarn"
"printim RTMA_April16042023-MAXTEMP_GWB_BIH_OD_CAP_PUNJ_HAR.jpg x1000 y741 white"
"close 1"
"quit"
