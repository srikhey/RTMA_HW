...
*******************************************
"sdfopen GLDAS_NOAH025_24HR.A20230412_20April2023.AIRTEMP_IND25km.nc"
"set lon  66.5 96.5"
"set lat 7.5 37.5"
"set xlopts 1 5 0.15"
"set ylopts 1 5 0.15"
...
"define T1=max((tair_f_inst-273.16),t=1,t=8)"
"define T2=max((tair_f_inst-273.16),t=9,t=16)"
"define T3=max((tair_f_inst-273.16),t=17,t=24)"
"define T4=max((tair_f_inst-273.16),t=25,t=32)"
"define T5=max((tair_f_inst-273.16),t=33,t=40)"
"define T6=max((tair_f_inst-273.16),t=41,t=48)"
"define T7=max((tair_f_inst-273.16),t=49,t=56)"
"define T8=max((tair_f_inst-273.16),t=57,t=64)"
"define T9=max((tair_f_inst-273.16),t=65,t=72)"
