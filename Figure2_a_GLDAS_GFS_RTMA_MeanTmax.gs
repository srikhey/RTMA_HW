...
*******************************************
"sdfopen Tmax_GLDAS.12th_20th042023_mean.nc "
"set lon  66.5 96.5"
"set lat 7.5 37.5"
"set xlopts 1 5 0.15"
"set ylopts 1 5 0.15"
...
"d smth9(tair_f_inst-273.16)"
"draw shp sd_boundary.shp"
"run grmask.gs"
"draw title GLDAS_MeanTmax"
"run cbarn"
"printim GLDAS_April12_20_2023_Ind-MeanTEMP.jpg x1000 y741 white"
"close 1"
"reinit"
"sdfopen Tmax_GFS.t00z.12th_20th042023_mean.nc"
"set lon  66.5 96.5"
"set lat 7.5 37.5"
"set xlopts 1 5 0.15"
"set ylopts 1 5 0.15"
...
"set clevs 24 26 28 30 32 34 36 38 40 42 45 47"
"set ccols 0 37 40 45 51 55 59 63 67 71 75 79 83 86"
"d smth9(tmax_2mabovegro-273.16)"
"draw shp sd_boundary.shp"
"run grmask.gs"
"draw title GFS_MeanTmax"
"run cbarn"
"printim GFS_April12_20_2023-MeanTEMP.jpg x1000 y741 white"
"close 1"
"reinit"
"sdfopen Tmax_RTMA.t00z.12th_20th042023_mean.nc"
"set lon  66.5 96.5"
"set lat 7.5 37.5"
"set xlopts 1 5 0.15"
"set ylopts 1 5 0.15"
...
"set clevs 24 26 28 30 32 34 36 38 40 42 45 47"
"set ccols 0 37 40 45 51 55 59 63 67 71 75 79 83 86"
"d smth9(tmp_2mabovegrou-273.16)"
"draw shp sd_boundary.shp"
"run grmask.gs"
"draw title RTMA_MeanTmax"
"run cbarn"
"printim RTMA_April12_20_2023-MeanTEMP.jpg x1000 y741 white"
"quit"